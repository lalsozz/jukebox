...
public class ContestService implements IContestService {
    ...
    private List<Question> pickQuestionsList(final List<Question> questions,final Integer numQuestion){
        List<Question> q = pickRandomQuestions(questions);
    ...
    public List<Contest> getAllContestLevelWise(Level level) {
        if (level == null) {
            List<Contest> con = contestRepository.findAll();

            return con;
        } else {
            List<Contest> c = contestRepository.findAllContestLevelWise(level);
            return c;
        }
    ...
    void validateContest(final Contest contest, final String contestCreator) throws InvalidContestException {
